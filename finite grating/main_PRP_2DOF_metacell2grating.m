...
grating.zeta_max = 8;  % PML damping strength max
grating.mlist = [0.049 0.017 0.073 0.049];
grating.klist = [4.3768e8 3.3455e7 1.6469e8 1.9081e8];
N_period = 10;  % Repeat the supercell to create a finite metasurface
...
m_selected = [[0.049 0.017 0.073 0.049], grating.mlist, [0.049 0.017 0.073 0.049]];
k_selected = [[4.3768e8 3.3455e7 1.6469e8 1.9081e8], grating.klist, [4.3768e8 3.3455e7 1.6469e8 1.9081e8]];
...
[tau_power, tau_pressure, W2_Gout, k_zGout, G, feature] = PWE4PlateResonatorPlateDimless2DOF_PML(plate,resonator,lattice,medium,incident,M,freq,grating);
